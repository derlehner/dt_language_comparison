 ...
 *   <li>{@link org.eclipse.vorto.core.api.model.datatype.impl.TypeImpl#getLang <em>Lang</em>}</li>
 * </ul>
 *
 * @generated
 */
public class TypeImpl extends MinimalEObjectImpl.Container implements Type {
	...
	public void setLang(VortoLangVersion newLang) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, DatatypePackage.TYPE__LANG, oldLang, lang));
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			...
			case DatatypePackage.TYPE__CATEGORY:
				return getCategory();
			case DatatypePackage.TYPE__LANG:
				return getLang();
		}
