 ...
 *   <li>{@link org.eclipse.vorto.core.api.model.functionblock.impl.OperationImpl#getPresence <em>Presence</em>}</li>
 *   <li>{@link org.eclipse.vorto.core.api.model.functionblock.impl.OperationImpl#isExtension <em>Extension</em>}</li>
 * </ul>
 *
 * @generated
 */
public class OperationImpl extends MinimalEObjectImpl.Container implements Operation {
	...
	public NotificationChain basicSetPresence(Presence newPresence, NotificationChain msgs) {
		...
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, FunctionblockPackage.OPERATION__PRESENCE, oldPresence, newPresence);
			if (msgs == null) msgs = notification; else msgs.add(notification);
		}
		return msgs;
	}
	...
	public void setPresence(Presence newPresence) {
		if (newPresence != presence) {
			NotificationChain msgs = null;
			if (presence != null)
				msgs = ((InternalEObject)presence).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - FunctionblockPackage.OPERATION__PRESENCE, null, msgs);
			if (newPresence != null)
				msgs = ((InternalEObject)newPresence).eInverseAdd(this, EOPPOSITE_FEATURE_BASE - FunctionblockPackage.OPERATION__PRESENCE, null, msgs);
			msgs = basicSetPresence(newPresence, msgs);
			if (msgs != null) msgs.dispatch();
		}
		else if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, FunctionblockPackage.OPERATION__PRESENCE, newPresence, newPresence));
	}
	...
	public void setExtension(boolean newExtension) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, FunctionblockPackage.OPERATION__EXTENSION, oldExtension, extension));
	}
