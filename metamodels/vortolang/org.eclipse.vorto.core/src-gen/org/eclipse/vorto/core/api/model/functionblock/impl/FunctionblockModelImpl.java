 ...
 *   <li>{@link org.eclipse.vorto.core.api.model.functionblock.impl.FunctionblockModelImpl#getLang <em>Lang</em>}</li>
...
public class FunctionblockModelImpl extends MinimalEObjectImpl.Container implements FunctionblockModel {
	 ...
	 * @ordered
	 */
	protected static final VortoLangVersion LANG_EDEFAULT = VortoLangVersion.VERSION1;
	 ...
	 * @ordered
	 */
	protected VortoLangVersion lang = LANG_EDEFAULT;
	 ...
	 * @generated
	 */
	public void setLang(VortoLangVersion newLang) {
		VortoLangVersion oldLang = lang;
		lang = newLang == null ? LANG_EDEFAULT : newLang;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, FunctionblockPackage.FUNCTIONBLOCK_MODEL__LANG, oldLang, lang));
	}
	...
	public void eSet(int featureID, Object newValue) {
		switch (featureID) {
			...
			case FunctionblockPackage.FUNCTIONBLOCK_MODEL__CATEGORY:
				...
				return;
			case FunctionblockPackage.FUNCTIONBLOCK_MODEL__LANG:
				setLang((VortoLangVersion)newValue);
				return;
			case FunctionblockPackage.FUNCTIONBLOCK_MODEL__FUNCTIONBLOCK:
