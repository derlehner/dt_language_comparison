...
/**
 * This is the item provider adapter for a {@link org.eclipse.vorto.core.api.model.functionblock.ReturnType} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class ReturnTypeItemProvider 
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_ReturnType_multiplicity_feature"), //$NON-NLS-1$
				 getString("_UI_PropertyDescriptor_description", "_UI_ReturnType_multiplicity_feature", "_UI_ReturnType_type"), //$NON-NLS-1$ //$NON-NLS-2$ //$NON-NLS-3$
				 FunctionblockPackage.Literals.RETURN_TYPE__MULTIPLICITY,
				 true,
				 false,
				 false,
	...
	public Object getImage(Object object) {
		return overlayImage(object, getResourceLocator().getImage("full/obj16/ReturnType")); //$NON-NLS-1$
	}
	...
	public String getText(Object object) {
		...
		return getString("_UI_ReturnType_type") + " " + returnType.isMultiplicity(); //$NON-NLS-1$ //$NON-NLS-2$
	}
