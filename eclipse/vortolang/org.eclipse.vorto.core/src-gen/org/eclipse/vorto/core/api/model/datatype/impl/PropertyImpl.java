 ...
 *   <li>{@link org.eclipse.vorto.core.api.model.datatype.impl.PropertyImpl#isExtension <em>Extension</em>}</li>
 * </ul>
 *
 * @generated
 */
public class PropertyImpl extends MinimalEObjectImpl.Container implements Property {
	...
	public void setExtension(boolean newExtension) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, DatatypePackage.PROPERTY__EXTENSION, oldExtension, extension));
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			...
			case DatatypePackage.PROPERTY__EXTENSION:
				return isExtension();
		}
