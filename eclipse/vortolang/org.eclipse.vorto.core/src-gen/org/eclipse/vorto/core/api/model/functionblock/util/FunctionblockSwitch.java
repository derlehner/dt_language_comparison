...
public class FunctionblockSwitch<T> extends Switch<T> {
	...
	protected T doSwitch(int classifierID, EObject theEObject) {
		switch (classifierID) {
			...
			case FunctionblockPackage.RETURN_DICTONARY_TYPE: {
				ReturnDictonaryType returnDictonaryType = (ReturnDictonaryType)theEObject;
				T result = caseReturnDictonaryType(returnDictonaryType);
				if (result == null) result = caseReturnType(returnDictonaryType);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case FunctionblockPackage.DICTONARY_PARAM: {
				DictonaryParam dictonaryParam = (DictonaryParam)theEObject;
				T result = caseDictonaryParam(dictonaryParam);
				if (result == null) result = caseParam(dictonaryParam);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
	...
	/**
	 * Returns the result of interpreting the object as an instance of '<em>Return Dictonary Type</em>'.
	 * <!-- begin-user-doc -->
	 * This implementation returns null;
	 * returning a non-null result will terminate the switch.
	 * <!-- end-user-doc -->
	 * @param object the target of the switch.
	 * @return the result of interpreting the object as an instance of '<em>Return Dictonary Type</em>'.
	 * @see #doSwitch(org.eclipse.emf.ecore.EObject) doSwitch(EObject)
	 * @generated
	 */
	public T caseReturnDictonaryType(ReturnDictonaryType object) {
		return null;
	}

	/**
	 * Returns the result of interpreting the object as an instance of '<em>Dictonary Param</em>'.
	 * <!-- begin-user-doc -->
	 * This implementation returns null;
	 * returning a non-null result will terminate the switch.
	 * <!-- end-user-doc -->
	 * @param object the target of the switch.
	 * @return the result of interpreting the object as an instance of '<em>Dictonary Param</em>'.
	 * @see #doSwitch(org.eclipse.emf.ecore.EObject) doSwitch(EObject)
	 * @generated
	 */
	public T caseDictonaryParam(DictonaryParam object) {
		return null;
	}
