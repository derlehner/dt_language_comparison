...
public class FunctionblockAdapterFactory extends AdapterFactoryImpl {
	...
	protected FunctionblockSwitch<Adapter> modelSwitch =
		new FunctionblockSwitch<Adapter>() {
			...
			@Override
			public Adapter caseReturnDictonaryType(ReturnDictonaryType object) {
				return createReturnDictonaryTypeAdapter();
			}
			@Override
			public Adapter caseDictonaryParam(DictonaryParam object) {
				return createDictonaryParamAdapter();
			}
			@Override
	...
	/**
	 * Creates a new adapter for an object of class '{@link org.eclipse.vorto.core.api.model.functionblock.ReturnDictonaryType <em>Return Dictonary Type</em>}'.
	 * <!-- begin-user-doc -->
	 * This default implementation returns null so that we can easily ignore cases;
	 * it's useful to ignore a case when inheritance will catch all the cases anyway.
	 * <!-- end-user-doc -->
	...
	/**
	 * Creates a new adapter for an object of class '{@link org.eclipse.vorto.core.api.model.functionblock.DictonaryParam <em>Dictonary Param</em>}'.
	 * <!-- begin-user-doc -->
	 * This default implementation returns null so that we can easily ignore cases;
	 * it's useful to ignore a case when inheritance will catch all the cases anyway.
	 * <!-- end-user-doc -->
